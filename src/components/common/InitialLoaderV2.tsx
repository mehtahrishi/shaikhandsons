...
/**
 * InitialLoaderV2 - Duplicate of InitialLoader with full responsiveness and slogan.
 */
              ...
              {!showText ? (
                        ...
                        <g transform="translate(18.8303,326)">
                          <g transform="translate(269.17,-192)">
                            <motion.path 
                              ...
                              animate={{ fill: ["rgb(255, 255, 255)", "rgb(239, 68, 68)", "rgb(255, 255, 255)"] }}
                ...
                >
                  ...
                  <div className="z-10 flex flex-col items-center justify-center py-12 px-8">
                    <h2 className="font-headline text-xl md:text-3xl font-black text-white tracking-widest text-center whitespace-nowrap">
                    ...
                    <motion.p
                      ...
                      className="mt-6 text-[9px] md:text-[11px] font-bold uppercase tracking-[0.4em] text-primary/80 text-center leading-relaxed"
                    >
