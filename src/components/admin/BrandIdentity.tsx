...
export const BrandIdentity = ({ collapsed = false, className = "" }: BrandIdentityProps) => (
  <div className={`flex items-center gap-2 group whitespace-nowrap overflow-visible transition-all duration-300 ${className}`}>
    {collapsed ? (
